...
export const getUserData: AppThunk = (history, pathname, accessToken) => (dispatch: AppDispatch) => {
  dispatch({
...
export const patchUserData: AppThunk = (history, pathname, accessToken, userDataObj) => (dispatch: AppDispatch) => {
  dispatch({
